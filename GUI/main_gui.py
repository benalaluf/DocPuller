...
from constants.config import DOCUMENT_FILE_TYPES, IMAGE_FILE_TYPES, AUDIO_FILE_TYPES, VIDEO_FILE_TYPES
from file_generators.executable_generator import DocPullerGenerator
...
class MainWindow(QWidget):
    ...
    def generate(self):
        ...
        file_type_gui = self.file_type_entry.currentText()
        file_type = None

        if file_type_gui == 'Document':
            file_type = DOCUMENT_FILE_TYPES
        elif file_type_gui == 'Image':
            file_type = IMAGE_FILE_TYPES
        elif file_type_gui == 'Audio':
            file_type = AUDIO_FILE_TYPES
        elif file_type_gui == 'Video':
            file_type = VIDEO_FILE_TYPES
        ...
        DocPullerGenerator(file_path, is_docPuller_type_usb, directories, file_type, (str(date_from), str(date_to)),
                           keywords,
                           server, port).main()
